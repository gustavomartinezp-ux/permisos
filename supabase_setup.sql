-- ============================================================
-- CESFAM Los Cerros — Setup completo para Supabase
-- Pega este archivo en: Supabase > SQL Editor > New query
-- ============================================================
...
INSERT INTO tipos_permisos (codigo, nombre, descripcion, dias_anuales_max, color) VALUES
  ...
  ('MATRIM',   'Permiso por Matrimonio',    '5 días hábiles por contracción de matrimonio', 5, '#EC4899'),
...
-- Verificación final
-- ============================================================
SELECT 'servicios' AS tabla, COUNT(*) FROM servicios
UNION ALL SELECT 'tipos_permisos', COUNT(*) FROM tipos_permisos
UNION ALL SELECT 'funcionarios', COUNT(*) FROM funcionarios
UNION ALL SELECT 'usuarios', COUNT(*) FROM usuarios
UNION ALL SELECT 'saldos_funcionarios', COUNT(*) FROM saldos_funcionarios;
